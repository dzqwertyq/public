...
{	
	...
	switch (cmd) {
		...
		case MOXA_SET_INTERFACE:
			...
			if(mxport->mxp_mxdev->mxd_model_name == MXU1_MODEL_7001)
			{
				switch(arg){
#ifndef NOT_ALLOW_RS232
					case MXU1_RS232:
						mxport->mxp_uart_mode = MXU1_UART_232;
						break;
#endif
#ifndef NOT_ALLOW_RS422
					case MXU1_RS422:
						mxport->mxp_uart_mode = MXU1_UART_485_RECEIVER_ENABLED;
						break;
#endif
#ifndef NOT_ALLOW_RS4854W
					case MXU1_RS4854W:
						mxport->mxp_uart_mode = MXU1_UART_485_RECEIVER_ENABLED;
						break;
#endif
#ifndef NOT_ALLOW_RS4852W
					case MXU1_RS4852W:
						mxport->mxp_uart_mode = MXU1_UART_485_RECEIVER_DISABLED;
						break;
#endif
